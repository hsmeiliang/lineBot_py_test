...
postbackRouter.add(message = '/ketoA', func = EatIntroduceController.ketoA)
postbackRouter.add(message = '/ketoB', func = EatIntroduceController.ketoB)
postbackRouter.add(message = '/ketoC', func = EatIntroduceController.ketoC)
postbackRouter.add(message = '/muscle', func = EatIntroduceController.muscle)
postbackRouter.add(message = '/muscleA', func = EatIntroduceController.muscleA)
...
postbackRouter.add(message = '/glutenC', func = EatIntroduceController.glutenC)
print('done')
